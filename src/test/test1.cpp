...
void test_gaussian_filter() {
    ...
    f.save_png("my-gaussian-filter_7");
...
void test_hybrid_image() {
    ...
    reconstruct.clamp();
    reconstruct.save_png("my-hybrid");
